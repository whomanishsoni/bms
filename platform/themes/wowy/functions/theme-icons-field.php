...
app()->booted(function (): void {
    ...
    $icons = [
        ...
        'wowy-font-diamond',
        'wowy-font-dress',
        'wowy-font-high-heels',
        'wowy-font-home',
        'wowy-font-kite',
        'wowy-font-smartphone',
        'wowy-font-teddy-bear',
        'wowy-font-tshirt',
        'fab fa-500px',
    ...
    $css = [
        Theme::asset()->url('css/vendors/fontawesome-all.min.css'),
        Theme::asset()->url('css/vendors/wowy-font.css'),
    ];
